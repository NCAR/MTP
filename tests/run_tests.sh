...
# add a -p to pattern match on which test files to run:
#
# Written in Python 3
#
...
###############################################################################
cd ../src
/usr/bin/python3 -m unittest discover -s ../tests -v -p "test_[0-9A-LN-Za-df-z]*py"
/usr/bin/python3 -m unittest discover -s ../tests -v -p "test_MTPclient*py"
/usr/bin/python3 -m unittest discover -s ../tests -v -p "test_MTPprocessor*py"
/usr/bin/python3 -m unittest discover -s ../tests -v -p test_MTPviewer.py
/usr/bin/python3 -m unittest discover -s ../tests -v -p test_MTPviewer2.py
/usr/bin/python3 -m unittest discover -s ../tests -v -p "test_eng1*py"
/usr/bin/python3 -m unittest discover -s ../tests -v -p "test_eng2*py"
/usr/bin/python3 -m unittest discover -s ../tests -v -p "test_eng3*py"
