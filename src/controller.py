...
from ctrl.lib.rootdir import getrootdir
from ctrl.lib.storeConfig import StoreConfig
from ctrl.lib.storePacket import StorePacket
from ctrl.model import modelMTP
from ctrl.lib.serialQt import SerialInit
from ctrl.lib.storePacket import StorePacket
from ctrl.view import controlWindow
...
def initSaveIWGFile(flightNumber, projectName):
    ...
    logger.printmsg("debug", "initIWGDataFile")
...
def initSaveDataFile(flightNumber, projectName):
    ...
    for filename in glob(dataPath + '\\*_' + flightNumber + '.mtp'):
        logger.printmsg("debug", "Save Data File Exists")
        saveDataFileName = filename
...
def main():
    ...
    # At some point I'd like to add the asctime tag to EOLpython logger
    ...
    logger.printmsg("debug", "dataFile: %r", dataFile)
