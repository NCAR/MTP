...
class MTPviewer(QMainWindow):
    ...
    def loadJson(self, filename):
        ...
        if self.client.reader.load(filename):
            self.setScanIndex()
            self.updateDisplay()
            if self.client.reader.testATP():  # If profile has been generated
                self.calcCurtain()
    ...
    def initView(self):
        ...
        # Modify so can jump to a specific scan. Can I give user ability to
        # type in this box? Or better to pick by time? Not sure... TBD
